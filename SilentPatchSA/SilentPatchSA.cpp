...
namespace CV
{
	namespace Funcs
	{
		...
		static BOOL (WINAPI *pSleepConditionVariableCS)(PCONDITION_VARIABLE, PCRITICAL_SECTION, DWORD) = nullptr;
 ...
 __declspec(naked) void DarkVehiclesFix1()
{
	...
	(
		...
		"test	al, 1\n"
		"jnz	DarkVehiclesFix1_DontApply\n"
		"mov	byte ptr %[bDarkVehicleThing], 1\n"
		"jmp	DarkVehiclesFix1_Return\n"

	"DarkVehiclesFix1_DontApply:\n"
		"mov	byte ptr %[bDarkVehicleThing], 0\n"
